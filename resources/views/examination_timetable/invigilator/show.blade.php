...
@section('content')
    <div class="container">
        ...
        dd($examination_timetable);

        <a href="{{ route('examination_timetable.invigilator.seating_arrangement', $examination_timetable->id) }}" class="btn btn-primary">View Seating Arrangement</a>
